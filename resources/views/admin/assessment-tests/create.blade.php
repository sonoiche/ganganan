...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 order-0 order-md-1">
            <!-- Project table -->
            <div class="card mb-6">
                <h5 class="card-header pb-0 text-sm-start text-center" style="margin-bottom: 15px">Create Question</h5>
                <div class="card-body">
                    <form action="{{ url('admin/assessment-tests') }}" method="post" enctype="multipart/form-data">
                        @csrf
